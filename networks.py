...
class Visual_Q_Network(nn.Module):
    ...
    def __init__(self, num_frame, num_action):
        ...
        self.conv1 = nn.Conv2d(in_channels=num_frame, out_channels=16, kernel_size=8, stride=4, padding=2)  # 输出图像大小为16x20x20
        self.conv2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=4, stride=2)    # 32x9x9
